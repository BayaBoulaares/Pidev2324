...
// Assuming you have a UserService instance named userService
                ...
                rs.ajouter(new Reclamation(userName, reclamation, Date.valueOf(date), ratingValue, prod.getId()));
    ...
    @FXML
    void Afficher(ActionEvent event) throws IOException, SQLException {
