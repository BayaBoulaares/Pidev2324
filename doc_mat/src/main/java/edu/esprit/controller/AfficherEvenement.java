...
public class AfficherEvenement {
    ...
    public void initialize() {
        try {
            // Clear the VBox before refreshing events
            eventVBox.getChildren().clear();

            Collection<Evenement> allEvents = serviceEvenement.getAll();
    ...
    @FXML
    private void displayEvents(Collection<Evenement> events) {
    ...
    private VBox createEventBox(Evenement evenement) {
     ...
     Label maxLabel = new Label("Nombre Restant :" + evenement.getNb_Max());
        ...
        ImageView editIcon = new ImageView(new Image("/fxml/images/editer.png"));
        ...
        ImageView deleteIcon = new ImageView(new Image("/fxml/images/supprimer.png"));
    ...
    private void handleSupprimerEvent(Evenement evenement) {
        try {
            ...
            Collection<Evenement> updatedEvents = serviceEvenement.getAll();
            HBox hbox = new HBox();
            hbox.setSpacing(30);
    ...
    private void handleModifierEvent(Evenement evenement) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/Modifier_Evenement.fxml"));
    ...
    private void handleConsulterSponsors(Evenement evenement) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/Afficher_Sponsor.fxml"));
            Parent root = loader.load();
    ...
    private void AjouterSponsors() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/Ajout_Sponsor.fxml"));
            Parent root = loader.load();
            Stage stage = new Stage();
            stage.setScene(new Scene(root));
            stage.showAndWait();
