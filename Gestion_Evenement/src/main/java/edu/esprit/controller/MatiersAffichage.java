...
private String annee;
    ...
    public void handleAfficheButtonClick(Matiere matiere) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AfficherDocumentM.fxml"));
 ...
 @FXML
    public void retourMAtiere(ActionEvent actionEvent) {
     try {
         FXMLLoader loader = new FXMLLoader(this.getClass().getResource("/fxml/acceuilMatiere.fxml"));
         Parent root = (Parent) loader.load();
         AcceuilMatiereC amc=loader.getController();
         amc.getPe(ep);
