...
class SponsorController extends AbstractController
{
    ...
    #[Route('/{idSopnsor}', name: 'app_sponsor_show', methods: ['GET'])]
    ...
    #[Route('/{idSopnsor}/edit', name: 'app_sponsor_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idSopnsor}', name: 'app_sponsor_delete', methods: ['POST'])]
    public function delete(Request $request, Sponsor $sponsor, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$sponsor->getIdSopnsor(), $request->request->get('_token'))) {
